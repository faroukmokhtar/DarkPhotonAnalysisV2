...
void trimscoutMakeTheCardsLMnew_2018D_cmsdas(string treepath = "scout_2.root", const char* outfilename = "./scout_cmsdas.root", bool isMC=false) {
 
   vector<string> filesToRun;
   vector<bool> isData;
   string dirIn="/eos/cms/store/group/phys_exotica/darkPhoton/jakob/newProd/2018/ScoutingRunD/ScoutingCaloMuon/crab_20200617_174740/200617_154747/0000/";
   //string dirIn="";
